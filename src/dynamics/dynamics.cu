...
template void Dynamics<MotionModel, MotionModelParams>::GPUSetup();
template void Dynamics<MotionModel, MotionModelParams>::paramsToDevice(bool);
template void Dynamics<MotionModel, MotionModelParams>::freeCudaMem();
template void Dynamics<MotionModel, MotionModelParams>::enforceConstraints(float*, float*);
template void Dynamics<MotionModel, MotionModelParams>::stateToOutput(const float* __restrict__,
                                                                       float* __restrict__);
template void Dynamics<MotionModel, MotionModelParams>::updateState(float*, float*, float*, const float);
template Dynamics<MotionModel, MotionModelParams>::state_array
Dynamics<MotionModel, MotionModelParams>::getZeroState() const;
