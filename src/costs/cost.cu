...
// Explicit instantiation so these member function bodies are actually compiled
// into the library for the concrete cost type used by controller.cpp.
template class Cost<MotionModelCost, MotionModelCostParams, MotionModel::DYN_PARAMS_T>;
